...
| Local HMAC guard | `tests/unit/test_local_hmac_guard.py` | Dev HMAC signer is blocked in production-like mode unless explicitly allowed for local/demo use. | Operators must not bypass the guard. |
